...
[Open an Issue](https://github.com/cjpatoilo/globbies/issues/new) to report any problems or improvements. When necessary, use some online service like a [JS Bin](https://jsbin.com), [JSFiddle](https://jsfiddle.net/), [Codepen](http://codepen.io/), to show the problem. Be sure to include some description to explain the problem.
...
1. Fork the Github repo: `git clone https://github.com/cjpatoilo/globbies.git`
...
**Globbies** uses [ESLint](http://eslint.org/), the pluggable linting utility for JavaScript.
...
*NOTE: The best way to learn about that is to just install it and give it a try on your code. **Globbies** uses an `.editorconfig` file, which most editors support, to enforce these coding standards.*
